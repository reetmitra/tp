...
public class CommandTestUtil {
    ...
    /**
     * Executes the given {@code command}, confirms that <br>
     * - a {@code CommandExecutionException} is thrown <br>
     * - the CommandExecutionException message matches {@code expectedMessage} <br>
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        assertThrows(CommandExecutionException.class, expectedMessage, () -> command.execute(actualModel));
